...
precip_data = xr.open_dataset('../../Data/Input_data/Precip_SAm_1970_2025_ERA5Land.nc')
...
data = xr.Dataset(
        ...
        attrs = dict(description='Bootstrapped composites of precip per analysis box for South America')
        )

data.to_netcdf('../../Data/Output_data/RidgePrecipImpact_SAm.nc')
